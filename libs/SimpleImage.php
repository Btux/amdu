<?php
/**
 *    Permet de redimensionner les images chargés sur le site
 */
class Image{
   ...
   */
   ...
   public static function resize($image, $width, $height, $options = array(), $quality = 100){
      $options['width'] = $width;
      $options['height'] = $height;
      return htmlImage(self::resizedUrl($image, $width, $height, $quality), $options);
   }
   ...
   */
   public static function resizedUrl($file, $width, $height, $quality = 100){
   ...
   imagecopyresampled($image_resized, $image_crop, 0, 0, 0, ($height_crop - $height) / 2, $width, $height, $width, $height);
